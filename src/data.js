const projects = [
  { 
    title: "Netatmo Showcase", 
    img:"./img/netatmo-mini.png",
    tags: "nuxt · tailwindCSS · directus",
    descriptionFR: "J'ai fait un an d'alternance chez Netatmo, où j'ai contribué à la migration du site vitrine vers Nuxt3.",
    description:"I spent my one year apprenticeship at Netatmo, where I contributed to the migration of the showcase website to Nuxt3.",
    date: "October 2023 - November 2024",
    stack: "Nuxt | Typescript | TailwindCSS | Directus | GraphQL",
    tools: "Git, Gitlab, Jira, Confluence, Microsoft",
    authors: "Camille Hébert & Netatmo web marketing team",
    length: "",
    fullstack:true,
    js:true,
    team:true,
    ...
    { 
      title: "Boukin", 
      img:"./img/boukin-mini.png",
      tags: "nuxt · django · docker · gitlabCI · TDD",
      descriptionFR: "Boukin est une application de suivi des livres prêtés et empruntés à ses amis. Il s'agit de mon projet de fin d'études qui condense tout ce que j'ai pu apprendre durant ma reconversion.",
      description:"Boukin is an application to track the books you lend to and borrow from your friends. This is my final-year project, which brings together everything I have learned throughout my career change.",
      date: "October 2024",
      stack: "Nuxt | Typescript | Django | PostgreSQL",
      tools: "Figma, Git, Gitlab, GitlabCI, VSCode",
      authors: "Benjamin Dromard, Justine Lambert, Camille Hébert",
      length: "",
      github:"https://gitlab.com/boukin",
      fullstack:true,
      js:true,
      team:true
    },
    { 
      ...
      descriptionFR: "MeloStream est une plateforme de streaming de musique. J'ai entamé ce projet afin de m'entraîner sur les requêtes API. Je souhaitais également améliorer mes compétences en React et apprendre TypeScript.",
