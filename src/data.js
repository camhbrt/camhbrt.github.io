const projects = [
    ...
    { 
      ...
      tools: "Docker, Figma, Git, Github, VSCode, Slack",
      authors: "Clément Badin, Hanâa Belhamidi, Benjamin Dromard, Camille Hébert, Sayadyna Mehraik, Mischaël Phémius, Clara Salazar, Bintou Traoré et Jean-Jacques Valmont",
      length: "2 semaines" ,
...
icon:`
  <svg fill="#d3aad9" viewBox="-51.2 -51.2 614.40 614.40" xmlns="http://www.w3.org/2000/svg" stroke="#d3aad9">
    <g istroke-width="0">
      <rect x="-51.2" y="-51.2" width="614.40" height="614.40" rx="122.88" fill="#e11d48" strokewidth="0"></rect>
    </g>
